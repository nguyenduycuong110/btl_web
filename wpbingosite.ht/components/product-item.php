<div class="product-item st-2 uk-position-relative">
    ...
    <div class="thumb uk-position-relative">
        <a href="/wpbingosite.ht/product.php" class="image img-scaledown"><img src="resources/img/special-<?php echo rand(0, 3); ?>.webp" alt=""></a>
    ...
    <div class="info uk-text-center">
        <?php require 'components/review.php'  ?>
            <div class="product-name"><a href="/wpbingosite.ht/product.php" title="">Charger 5v 2a Us Lens</a></div>
